...
from model import AdamsGCN, GraphModel
...
def load_experiment_configuration() -> (
    ...
    # Configure whether to print anything when running this script (this config is always printed)
    verbose = False
...
def load_datasets(
    train: bool = True, val: bool = True, test: bool = True
...
if __name__ == "__main__":
    ...
    load_feature_storage()
    ds_train, ds_val, ds_test = load_datasets(train=True, val=True, test=True)
